...
export class RecipeService {
  ...
  protected recipeTypeList: RecipeTypeInfos[] = 
  [
    {
      id: 0,
      name: 'Apple Pie',
  ...
  getAllRecipes(): RecipeTypeInfos[] {
    return this.recipeTypeList;
  }

  getRecipeById(id: number): RecipeTypeInfos | undefined {
    return this.recipeTypeList.find((RecipeType) => RecipeType.id === id);
  }
}
